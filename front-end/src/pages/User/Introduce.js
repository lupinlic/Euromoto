    ...
    return (
        <div>
            ...
            <div className='container mt-3'>
                ...
                <p style={{ marginLeft: '12px' }}>Chào mừng quý khách đến với Hoàng Kiên – điểm đến đáng tin cậy cho những người yêu thích xe máy tại khu vực! Chúng tôi chuyên cung cấp các dòng xe máy chất lượng từ những thương hiệu hàng đầu như Honda, Yamaha và SYM,
                    đáp ứng nhu cầu đa dạng của khách hàng từ những mẫu xe tay ga tiện lợi, đến xe số bền bỉ và mạnh mẽ.</p>
                <p style={{ fontSize: '24px' }}>Tại sao nên chọn Hoàng Kiên?</p>
                ...
                <p style={{ marginLeft: '12px' }}>Dịch vụ hậu mãi chu đáo: Hoàng Kiên không chỉ bán xe mà còn mang đến cho khách hàng những dịch vụ bảo dưỡng, sửa chữa tận tâm với đội ngũ kỹ thuật viên lành nghề.</p>
                ...
                <p>Hãy đến ngay Hoàng Kiên để trải nghiệm và chọn cho mình một chiếc xe phù hợp với phong cách và nhu cầu của bạn! Chúng tôi tự hào là người bạn đồng hành tin cậy trên mọi hành trình của bạn.</p>
            </div>
        </div>
    )
}
