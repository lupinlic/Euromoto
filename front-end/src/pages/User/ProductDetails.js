...
function ProductDetails() {
  ...
  const fetchProducts = async () => {
    try {
      ...
      const versionRes = await productApi.getProductVersionByID(productID);
      setVersion(versionRes.data);

      const total = versionRes.data.reduce(
        (sum, version) => sum + version.ProductVersionQuantity,
        0
      );
      setTotalQuantity(total);

      const colorRes = await productApi.getProductColorByID(productID);
      setColor(colorRes.data);

      if (colorRes.data.length > 0) {
        setSelectedImage(buildImageUrl(colorRes.data[0]));
        setLoai(colorRes.data[0].product.category.CategoryName);
        setThuonghieu(
          colorRes.data[0].product.category.parent.CategoryParentName
        );
        setMasp(colorRes.data[0].product.ProductID);
      }

      const allRes = await productApi.getAll();
      setProductall(allRes);
    } catch (err) {
  ...
  const tabs = [
    ...
    },
    {
      ...
      content: "Nội dung thông số kỹ thuật...",
    },
    {
      id: "guide",
      label: "Hướng dẫn mua hàng",
      content: "Nội dung hướng dẫn mua hàng...",
    },
    {
      id: "reviews",
    ...
    <>
      ...
      <div className="container mt-5">
        ...
        <div className="mt-4 row">
              ...
              {color?.map((img, index) => (
                <div className="col-md-3 col-3 mt-1">
                  <div
                    ...
                    style={{
                      border:
                        selectedImage === buildImageUrl(img)
                          ? "2px solid #014686"
                          : "2px solid #d8d7d7",
                      height: "113px",
                      borderRadius: "5px",
          ...
          <div className="col-md-4">
            ...
            <div className="price-box">
              {Number(products?.ProductPrice).toLocaleString("vi-VN")}
            ...
            <div className="service-pro mt-4">
              ...
              >
                <img
                  src="https://bizweb.dktcdn.net/100/519/812/themes/954445/assets/km_product1.png?1741709416058"
                  alt=""
                />
                <p className="m-0">
              ...
              >
                <img
                  src="https://bizweb.dktcdn.net/100/519/812/themes/954445/assets/km_product3.png?1741709416058"
                  alt=""
                />
                <p className="m-0">
                  Tặng 100.000₫ mua hàng tại website thành viên Euro moto, áp
            ...
            <div className="service-pro">
              ...
              <ul className="commit-list">
                <li>
                  ...
                  <p>Cam kết 100% hàng chuẩn, nguồn gốc rõ ràng.</p>
                </li>

                <li>
                  <div className="top-line">
                    <span className="check">✓</span>
                    <b>Giá tốt trực tiếp</b>
                  </div>
                  <p>Luôn đảm bảo giá cạnh tranh nhất thị trường.</p>
                </li>

                <li>
                  <div className="top-line">
                    <span className="check">✓</span>
                    <b>Combo quà chất lượng</b>
                  </div>
                  <p>Tặng kèm nhiều bộ quà hữu ích và giá trị.</p>
                </li>
                ...
                <li>
                  ...
                  <p>Vận chuyển nhanh, hỗ trợ kiểm tra khi nhận.</p>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="mt-5 d-none d-md-block">
          <div className="col-md-9">
            <div className="product-tab">
              <div className="title-tab">Thông tin sản phẩm</div>
              <div className="row">
                <div className="col-md-3">
                  <div className="d-flex flex-column gap-2">
                    {tabs.map((tab) => (
                      <div
                        ...
                        style={{
                          border:
                            activeTab === tab.id ? "none" : "2px solid #d8d7d7",
                          background: activeTab === tab.id ? "#014686" : "#fff",
        ...
        <div className="d-none d-md-block">
          <Title titleName="Sản phẩm" titleDes="liên quan"></Title>
